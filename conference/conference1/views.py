...
def conference_list(request):
    conferences = [
        ...
        {'name': 'Conference 2', 'dates': 'July 15-17, 2023', 'location': 'City B'},
        {'name': 'Conference 3', 'dates': 'August 5-7, 2023', 'location': 'City C'},
        {'name': 'Conference 4', 'dates': 'September 10-12, 2023', 'location': 'City D'},
